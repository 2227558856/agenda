package org.project.agenda.role.constant;
...
public class RoleConstants {
    ...
    public static final class Result {
         ...
         * 账号已存在
         */
        public static final int ROLE_IS_EXIST = 50009;
        /**
         * 账号已存在
         */
        ...
        public static void init() {
            ...
            BaseResultConstants.addResultInfo(ROLE_IS_EXIST, Message.ROLE_IS_EXIST);
    ...
    public static final class Message {
        ...
        public static final String ROLE_IS_EXIST = "角色已存在";
